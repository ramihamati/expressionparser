...
namespace Digitteck.ExpressionParser.ExprParameter
{
    ...
    {
        public new Int64 GetValue() => this.Value;

        public ParameterInt64(string name, Int64 value) : base(name, value)
        {
            this.Value = value;
        }
        public static ParameterInt64 Create(Int64 value)
        {
            return new ParameterInt64(ParametersManager.NextName(), value);
        }
